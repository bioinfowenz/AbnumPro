...
If you wish to modify AbNumPro, please access the [AbnumPro_source_code](https://github.com/bioinfowenz/AbnumPro/blob/main/AbnumPro_source_code). However, we strongly recommend using the precompiled version provided.
